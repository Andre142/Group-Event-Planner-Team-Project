...
public class BlockedListServletTest extends TestCase {
    ...
    public void testDoGet() throws IOException, SQLException {
        ...
        writer.flush();
        res = HelperMethods.shared().fromJson(stringWriter.toString(),Response.class);
        assertTrue(res.getStatus());
        ...
        writer.flush();
        Response<ArrayList<String>> res1 = HelperMethods.shared().fromJson(stringWriter.toString(),Response.class);
        assertTrue(res.getStatus());
